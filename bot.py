...
SOZBORSA_URL = os.environ.get("SOZBORSA_URL", "https://xatbosim9-ai.github.io/Koreya_bot/sozborsa.html")
...
def main_menu_kb():
    keyboard = [
        ...
        [InlineKeyboardButton("📊 Sozborsa", web_app=WebAppInfo(url=SOZBORSA_URL))],
